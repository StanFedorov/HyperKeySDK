 ...
 */
// TODO: Fill in the API keys below with your developer v2 keys.
static NSString * const kConsumerKey       = @"URr-kXhHvlBZP3yP-vdenA";
static NSString * const kConsumerSecret    = @"O_ORETTAZ_h9QQJ6muTItiCyr7I";
static NSString * const kToken             = @"Qie5uoexZw0lEAjtfQz6k00l0EzvVT3u";
static NSString * const kTokenSecret       = @"0tOjiXyKwBsnpUim4r1dg8RsPyU";
